...
import ba.go2balkan.jwt.JwtTokenUtil;
...
//        JwtUserDetails user = (JwtUserDetails) jwtInMemoryUserDetailsService.loadUserByUsername(username);
        //Code line above can be uncommented if code below becomes unused
        Account user = (Account) jwtInMemoryUserDetailsService.loadUserByUsername(username);
