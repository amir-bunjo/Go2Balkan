...
/**
 * The persistent class for the cb_accommodation_pool_spa database table.
 * 
 */
@Entity
@Table(name="cb_accommodation_pool_spa")
@NamedQuery(name="CbAccommodationPoolSpa.findAll", query="SELECT c FROM CbAccommodationPoolSpa c")
public class CbAccommodationPoolSpa implements Serializable {
