...
/**
 * The persistent class for the cb_accommodation_food_drink database table.
 * 
 */
@Entity
@Table(name="cb_accommodation_food_drink")
@NamedQuery(name="CbAccommodationFoodDrink.findAll", query="SELECT c FROM CbAccommodationFoodDrink c")
public class CbAccommodationFoodDrink implements Serializable {
	...
	public CbAccommodationFoodDrink() {
	}
